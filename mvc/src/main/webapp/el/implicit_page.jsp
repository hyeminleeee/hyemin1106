...
<body>
	...
	<hr>
	<h2>EL 미사용</h2>
	<%-- request 내장객체 : HttpServletRequest 객체로 요청정보를 저장한 객체 --%>
	...
	<h2>EL 사용</h2>
	<%-- EL 표현식에서 pageContext 내장객체를 사용하면 PageContext 객체를 제공받아 사용 가능 --%>
	<%-- => EL 표현식에서 pageContext 내장객체를 사용해 PageContext 객체의 메소드 호출 가능 --%>
	<%-- => PageContext 객체의 메소드 대신 get 단어를 제외한 이름을 사용해 메소드 호출 가능 --%>
