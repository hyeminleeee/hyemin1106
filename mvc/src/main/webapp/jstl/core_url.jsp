...
<body>
	...
	<%-- 해결법)웹자원 경로의 URL 주소는 절대경로로 표현하여 사용 --%>
	...
	<%-- 해결법) 컨텍스트 최상위 디렉토리의 경로를 제공받아 웹자원의 경로로 표현하여 사용 --%>
	<img alt="코알라" src="/mvc/jstl/images/Koala.jpg" width="200">

	<%-- request.getContextPath() 메소드를 호출하여 컨텍스트 최상위 디렉토리의 경로를 제공받아 웹자원의 경로 표현 --%>
	<img alt="코알라" src="<%=request.getContextPath() %>/jstl/images/Koala.jpg" width="200">
	
	<%-- EL 표현식에서 pageContext 객체를 사용해 컨텍스트 최상위 디렉토리의 경로를 제공받아 웹자원의 경로 표현 --%>
