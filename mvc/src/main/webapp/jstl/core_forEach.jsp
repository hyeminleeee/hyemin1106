...
<body>
	...
	<%-- begin 속성: Scope 속성값으로 저장될 시작값(Integer 객체)를 속성값으로 설정 --%>
	<%-- end 속성: Scope 속성값으로 저장될 종료값(Integer 객체)를 속성값으로 설정 --%>
	<%-- step 속성: Scope 속성값을 변경하기 위한 증가값(Integer 객체)를 속성값으로 설정 --%>
