...
<body>
	<h1>속성값으로 저장된 객체의 사용범위(Scope)</h1>
	<hr>
	<p>JSP 문서에서 생성된 객체를 내장객체의 속성값으로 저장하여 다른 JSP 문서에서 속성값을 객체로
	반환받아 사용할 수 있는 범위 - 내장객체에 따라 저장된 속성값이 사용되는 범위가 다르게 설정</p>
	<hr>
	<p>page Scope : pageContext 내장객체를 사용하여 객체를 속성값으로 저장
	...
	반환받아 사용 가능</p>
	<p>session Scope : session 내장객체를 사용하여 객체를 속성값으로 저장
	- 같은 세션이 바인딩된(브라우저가 같은 경우) 모든 JSP 문서에서 속성값을 객체로 반환받아 사용 가능</p>
	<p>application Scope : application 내장객체를 이용하여 객체를 속성값으로 저장
	- 모든 JSP 문서에서 속성값을 객체로 반환받아 사용 가능</p>
	<hr>
	<p>내장객체를 사용하여 객체를 속성값으로 저장하는 메소드
