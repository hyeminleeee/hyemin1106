<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%-- 선언문(Declaration) : 필드 또는 메소드를 선언하는 명령을 작성하는 영역 --%>
<%-- => 서블릿 객체가 생성될 때 실행 --%>
<%!
...
<%-- => 요청 처리 메소드의 명령으로 클라이언트 요청에 의해 실행 --%>
<% 
	//d요청 처리 메소드에서 생성되는 지역변수
...
<body>
	...
	<hr>
	<%-- out(Writer 객체) : Java 명령의 실행결과를 응답파일에 전달하기 위한 출력스트림 --%>
	<%-- <p>JSP 문서의 요청 횟수 = <% out.println(count); %></p> --%>
	<%-- 표현식(Expression) : 값(변수값, 연산식의 결과값, 메소드의 반환값)을 제공받아 응답파일에 포함
	하기 위한 영역 제공 --%>
