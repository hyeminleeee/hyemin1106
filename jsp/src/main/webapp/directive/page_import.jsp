...
<%-- page 디렉티브의 import 속성과 속성값은 이클립스에 자동 완성 기능으로 작성 가능 --%>
<%@page import="java.util.ArrayList"%>
<%@page import="java.util.List"%>
<%-- page 디렉티브에 같은 이름의 속성을 여러번 사용할 경우 에러 발생 가능 --%>
<%-- => import 속성만 제외 --%>
...
<%
	...
	List<String> nameList=new ArrayList<>();//객체 생성시 제네릭으로 사용할 Java 자료형 생량 가능
	nameList.add("홍길동");
	nameList.add("임꺽정");
	nameList.add("전우치");
	nameList.add("일지매");
