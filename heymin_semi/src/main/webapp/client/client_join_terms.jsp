...
<!-- 개별 CSS -->
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/css/join_terms.css">
...
<div id="join_termsArea" class="join_termsArea">
	...
	<div id="head_text" class="head_text">
		...
		<div id="head_text_right" class="head_text_right">
			<p>
				<span id="current_stage">01 약관동의 &nbsp;▶</span>&nbsp; 02 정보입력
				&nbsp;▶&nbsp; 03 가입완료
			</p>
		</div>
...
이 약관은 (주)캠핑퍼스트가 운영하는 초캠몰 사이버 몰(이하 "몰"이라 한다)에서 제공하는 인터넷 관련 서비스(이하 "서비스"라 한다)를 이용함에 있어 사이버몰과 이용자의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.
※ 「PC통신등을 이용하는 전자거래에 대해서도 그 성질에 반하지 않는한 이 약관을 준용합니다」


제2조(정의)

① "몰"이란 (주)캠핑퍼스트 회사가 재화 또는 용역을 이용자에게 제공하기 위하여 컴퓨터등 정보통신설비를 이용하여 재화 또는 용역을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.
...
이용자의 개인정보는 원칙적으로 개인정보의 수집 및 이용 목적 달성 시 지체없이 파기합니다. 다만 다른 법령에서 별도의 기간을 정하고 있는 경우나 이용자의 요청에 따라 기간을 달리 정한 경우에는 그 기간이 경과한 후 파기 등의 필요한 조치를 취합니다.</pre>
							</td>
						</tr>
					</table>
				</li>
...
- 제공받는 자 : 주식회사 바이앱스, 주식회사 엔에이치앤커머스, 주식회사 크리마
- 이용목적 : 쿠폰 발급 및 회원 대상의 마케팅을 위한 개인정보 이용
- 제공항목 : 구매자정보(이름,전화번호,휴대폰번호,이메일), 상품 구매/취소/반품/교환/환불 정보, 수령인 정보(이름, 주소, 전화번호, 휴대폰번호)
- 보유/이용기간 : 회원탈퇴 후 5일까지
