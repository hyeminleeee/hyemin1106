...
<body>
	<div id="mainWrap" class="wrap_main">
		...
		<div id="mAticle" class="cont_article">
			...
			<div class="section_banner">
				<div class="slide_banner banner1">
					<div class="inner_slide">
						<strong>텍스트</strong>
						<p>
							내용내용  내용내용내용내용내용내용내용내용내용내용<br>
							내용내용 내용내용내용내용내용내용내용내<br>
							내용내용 내용내용내용내용내용내용내용내
						</p>
						<span>서브내용</span>
					</div>
				</div>
					...
					<ul class="list_product slick_list">
						<li>
							<a href="#" class="link_product">
								<span class="wrap_img">
									<img src="images/27813_main_028.jpg" alt="집게" class="img_product">
								</span>
