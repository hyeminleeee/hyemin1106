...
//키보드로 학번을 입력받아 STUDENT 테이블에서 NO 컬럼값이 입력된 학번과 같은 행을 삭제하는 JDBC
...
public class CallableStatementApp {
	public static void main(String[] args) throws NumberFormatException, IOException, SQLException {
		...
		//CallableStatement.registerOutParameter(int parameterIndex, int sqlType) : 저장 프로시저의
		...
		if(name==null) {//삭제된 행이 없는 경우
			...
			System.out.println("[메세지]"+name+"님의 학생정보를 삭제하였습니다.");
		}		
		System.out.println("=================================================================");
