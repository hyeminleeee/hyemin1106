...
public class StatementApp {
	...
	public static void main(String[] args) throws NumberFormatException, IOException, SQLException {
		...
		System.out.println("=================================================================");
		//키보드로 입력받은 학생정보를 STRUDENT 테이블에 행으로 삽입하여 저장
		Connection con=ConnectionFactory.getConnection();
		
		Statement stmt=con.createStatement();
		
		//String sql1="insert into student values(1000,'홍길동','010-1234-5678','서울시 강남구','1999-05-05')";
		...
		System.out.println("=================================================================");
		//STRUDENT 테이블에 저장된 모든 행(학생정보)을 검색하여 출력
		...
		*/
		...
		//키보드로 이름을 입력받아 STUDENT 테이블에서 NAME 컬럼에 해당 이름이 저장된 행만 검색하여
		//출력하는 JDBC 프로그램 작성
		...
		String name=in.readLine();
		System.out.println("=================================================================");
		//STUDENT 테이블에서 NAME 컬럼에 해당 이름이 저장된 행을 검색하여 출력
		Connection con=ConnectionFactory.getConnection();
		...
		String sql="select no,name,phone,address,birthday from student where name='"
				+name+"' order by no";
