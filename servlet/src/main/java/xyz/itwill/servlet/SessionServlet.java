...
//만들어 서블릿에 바인딩 처리하고 생성된 세션의 식별자(SessionID)를 클라이언트에게 [JSESSIONID]
...
public class SessionServlet extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<hr>");
		//HttpSession.isNew() : 세션을 트랙킹하여 바인딩한 경우 [false]를 반환하고 세션을 
		...
		//=> 세션의 연결 지속성을 제공하기 위한 값(객체)을 저장하기 위한 메소드
