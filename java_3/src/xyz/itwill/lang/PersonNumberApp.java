...
//키보드로 주민번호를 입력받아 생년월일과 성별을 계산하여 출력하는 프로그램
//=> 주민번호는 14자리로 입력받고 7번째 자리에 [-] 문자가 존재받도록 처리
...
public class PersonNumberApp {
	public static void main(String[] args) {
		...
		//성별을 저장하기 위한 변수
		String gender="";
		if(separation.equals("1") || separation.equals("3")) {//20세기(19xx)에 태어난 경우
			gender+="남자";//변수에 저장된 문자열에 문자열을 결합하여 변수에 저장
