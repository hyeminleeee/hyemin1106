...
////=> 온라인 API 문서 - https://docs.oracle.com/en/java/javase/22/docs/api/index.html
...
//Math 클래스 : 수학 관련 기능을 상수필드 및 정적메소드로 제공하는 클래스
//System 클래스 : 표준 입출력 스트림을 제공하거나 시스템 관련 기능을 정적메소드로 제공하는 클래스
//=> 은닉화되어 있어서 객체를 생성할 수 없다. 
...
public class SystemApp {
	public static void main(String[] args) {
		...
		//변환하여 반환하는 메소드
		//시간값(TimeStamp) : 날짜와 시간을 정수값으로 표현하기 위해 만들어진 값
