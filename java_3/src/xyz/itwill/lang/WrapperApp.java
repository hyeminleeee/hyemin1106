...
public class WrapperApp {
	public static void main(String[] args) {
		...
		*/
		...
		//Integer.valueOf(int i) : 매개변수로 전달받은 값이 정수값으로 저장된 Integer 객체로 저장된 정적메소드
		Integer num1=Integer.valueOf(100);
		//Integer.valueOf(Object i) : 매개변수로 전달받은 객체를 정수값으로 변환해 정수값이 
		//저장된 Integer 객체로 저장된 정적메소드
		...
		*/
		...
		//Integer.toOctalString(int i) : 매개변수로 전달받은 정수값을 8진수 형태의 문자열로
		//변환하여 반환하는 정적메소드
		System.out.println("su(8진수) = "+Integer.toOctalString(su));
		//Integer.toHexString(int i) : 매개변수로 전달받은 정수값을 16진수 형태의 문자열로
		//변환하여 반환하는 정적메소드
		System.out.println("su(16진수) = "+Integer.toHexString(su));
		//Integer.toBinaryString(int i) : 매개변수로 전달받은 정수값을 2진수 형태의 문자열로
		//변환하여 반환하는 정적메소드
