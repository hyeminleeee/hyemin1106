...
public class StringApp {
	public static void main(String[] args) {
		...
		//참조변수를 비교연산자로 비교하면 참조변수의 저장된 메모리주소를 비교하여 결과 제공
		if(str1 == str2) {
		...
		System.out.println("=================================================================");
		//new 연산자로 String 클래스의 생성자를 호출하여 String 객체를 생성하면 String 객체는
		//힙영역에 생성
		...
		if(str1.equals(str3)) {
			System.out.println("str1 변수와 str3 변수에 참조하는 String 객체의 메모리주소가 같습니다.");
		} else {
			System.out.println("str1 변수와 str3 변수에 참조하는 String 객체의 메모리주소가 다릅니다.");
		}
		System.out.println("=================================================================");
		String str4="abc";
		
		if(str1.equals(str4)) {
			System.out.println("str1 변수와 str4 변수에 참조하는 String 객체의 메모리주소가 같습니다.");
		} else {
			System.out.println("str1 변수와 str4 변수에 참조하는 String 객체의 메모리주소가 다릅니다.");
		}
		System.out.println("=================================================================");
		...
		//String.compareTo(String s) : String 객체에 저장된 문자열과 매개변수로 전달받은 String
		//객체의 문자열을 비교하여 String 객체에 저장된 문자열 크면 [양수]를 반환하고
		//작으면 [음수]를 반환하며 같은 경우 [0]을 반환하는 메소드
		//=> 비교 문자열이 영문자인 경우 대소문자를 구분하여 비교
		if(str1.compareTo(str4) > 0) {
			...
			System.out.println("str1 변수가 참조하는 String 객체의 문자열이 str4 변수가 참조하는 String 객체의 문자열과 갑습니다.");
		}
		System.out.println("=================================================================");
		...
		System.out.println();
		System.out.println("=================================================================");
		//String 클래스의 생성자 매개변수에 byte 배열을 전달하여 문자열이 String 객체 생성
		String str5=new String(new byte[] {'A', 'B','C','D','E','F','G'});
		System.out.println("srt5 = "+str5);
		...
		System.out.println("=================================================================");
		//String.indexOf(int ch) : String 객체에 저장된 문자에서 매개변수로 전달받은 문자울
		//처음부터 차례대로 검색하여 검색된 문자의 시작위치값(첨자)를 반환하는 메소드
		System.out.println("A 문자의 저장 위치 = "+str5.indexOf('A'));
		//String.indexOf(String str) : String 객체에 저장된 문자열에서 매개변수로 전달받은 문자열울
		...
		//String.trim() : String 객체에 저장된 문자열에 앞과 뒤에 존재하는 공백을 제거한
		//문자열을 반환하는 메소드
		...
		//정규표현식에서 사용하는 메타문자를 일반문자로 사용하기 위해서는 [\\]를 붙여 표현
		String[] stringArray=str9.split("\\*");
		...
		//매개변수로 전달받은 시작첨자 위치의 문자부터 종료첨자 위치의 문자 전까지 문자열을
		//분리하여 문자열로 반환하는 메소드
		...
		//시작첨자 위치의 문자부터 마지막 문자까지 분리하여 문자열을 반환하는 메소드
		...
		//[문자열+숫자값] 또는 [숫자값+문자열] 형식의 연산식을 사용하면 모든 숫자값을 문자열과 
		//결합해 문자열로 제공받아 사용 가능
