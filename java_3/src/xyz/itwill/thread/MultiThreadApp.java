...
//1. Thread 클래스를 상속받은 자식클래스(내부클래스 권장) 선언
...
//=> Thread 객체로 새로운 스레드가 생성되어 자동으로 run() 메소드를 호출해 명령 실행
...
public class MultiThreadApp {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		*/
		...
		//Thread 객체를 참조하여 start() 메소드 외에 다른 메소드를 호출하지 않을 경우 참조변수에
		...
		*/
		...
		//작성된 함수형 인터페이스로 사용 가능 - 람다표현식을 사용하여 객체 생성 가능
		new Thread(()-> {
				for(char i='a'; i<='z'; i++) {
					System.out.print(i);
					try {
