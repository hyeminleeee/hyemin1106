...
public class PenguinMoveApp extends JFrame {
	...
	public PenguinMoveApp(String title) {
		...
		//Object.getClass() : 현재 사용중인 클래스에 대한 정보가 Class 객체를 반환하는 클래스
		...
		//프레임에서 키보드 관련 이벤트가 발생될 경우 이벤트를 처리하기 위해 이벤트 처리 객체 등록
		...
		addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				...
				case KeyEvent.VK_LEFT :
					...
					penguinNo++;
					//나머지는 0~2 범위의 정수값을 제공받아 변수에 저장(~부터 ~까지를 표현)
					//ex)10으로 나누면 0~9, 3으로 나누면 0~2
					penguinNo%=3;
