...
public class CharacterStreamApp {
	public static void main(String[] args) throws IOException {
		...
		//InputStreamReader 클래스 : 매개변수로 InputStream 객체를 전달받아 문자데이터를
		//제공받을 수 있는 입력스트림(Reader 객체)을 생성하기 위한 클래스 - 스트림 확장
		//=> 키보드 입력값을 인코딩 처리된 문자값으로 전달받기 위한 입력스트림 생성
		InputStreamReader in=new InputStreamReader(System.in);
		
		
		//OutputStreamWriter 클래스 : 매개변수로 OutputStreamWriter 객체를 전달받아 문자데이터를
		//제공할 수 있는 출력스트림(Writer 객체)을 생성하기 위한 클래스 - 스트림 확장
		//=> 모니터에 인코딩 처리된 문자값으로 전달받기 위한 입력스트림 생성
		//OutputStreamWriter out=new OutputStreamWriter(System.out);
		
		//PrintWriter 클래스 : 매개변수로 OutputStream 객체를 전달받아 문자데이터를
		//제공할 수 있는 출력스트림(Writer 객체)을 생성하기 위한 클래스 - 스트림 확장
		//=> OutputStreamWriter 클래스를 상속받은 자식클래스로 다양한 출력메소드 제공(더 다양)
		PrintWriter out=new PrintWriter(System.out);
		
		//키보드 입력값(2Byte - 원시테이터)을 저장하기 위한 변수
		int readByte;
