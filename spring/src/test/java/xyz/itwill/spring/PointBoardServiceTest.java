...
public class PointBoardServiceTest {
	...
	public void test1() {
		...
		//문제점 : 예외 발생전에 게시글 삽입에 대한 SQL 명령은 이미 실행되어 POINT_BOARD 테이블에는
		//비정상적인 행 삽입 처리
		//해결법 : 예외가 발생되기 전에 실행된 모든 SQL 명령(INSERT, UPDATE, DELETE)은 롤백 처리
		// => Spring 프레임워크에서는 TransactionManager 기능을 사용해 일관성 있는 트렌젝션 관리 기능 제공
