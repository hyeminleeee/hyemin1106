...
public class MessagePrintApp {
	public static void main(String[] args) {
		...
		HiMassageObject object=new HiMassageObject();
		MessagePrintObjcet print=new MessagePrintObjcet();
		//매개변수에 객체를 전달하여 필드에 저장 - 포함관계(의존관계)
		...
		*/
		...
		MessagePrintObjcet print=(MessagePrintObjcet)context.getBean("messagePrintObjcet");
		print.messagePrint();
