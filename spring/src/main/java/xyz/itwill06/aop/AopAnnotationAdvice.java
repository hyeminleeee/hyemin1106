...
// => Spring Bean Configuration File의 aspectj-autoproxy 엘리먼트
@Aspect
public class AopAnnotationAdvice {
	...
	public void afterLog() {
		System.out.println("### [after]핵심관심코드 실행된 후에 무조건 삽입되어 실행될 횡단관심코드 ###");		
	}
	...
	public void afterReturningLog() {
		System.out.println("### [after-returning]핵심관심코가 정상적으로 실행된 후에 삽입되어 실행될 횡단관심코드 ###");		
	}
	...
	public void afterThrowingLog() {
		System.out.println("### [after-throwing]핵심관심코 실행시 예외가 발생된 후에 삽입되어 실행될 횡단관심코드 ###");		
	}
