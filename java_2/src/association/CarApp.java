...
public class CarApp {
	public static void main(String[] args) {
		//엔진 클래스에 기본 생성자를 사용하여 객체를 생성 - 엔진 생성
		...
		//Car 클래스에 기본 생성자를 사용하여 객체를 생성 - 자동차 생성
		Car carOne=new Car();
		...
		carOne.displayCar();
		System.out.println("=========================================================");
		//Car 클래스에 매개변수가 작성된 생성자를 사용하여 객체를 생성 - 자동차 생성
		//=>엔진 클래스에 매개변수가 작성된 생성자를 사용하여 매개변수에 전달하여 객체를 생성 - 엔진 생성
