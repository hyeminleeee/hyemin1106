...
<body>
	...
	*/
	...
	document.getElementById("btn1").onclick=function() {
		//XMLHttpRequest 객체를 생성하여 전역번수에 저장
		...
		//, DELETE(삭제) 등 (통상적으로 POST 이하(put,patch,delete)는 다 POST 방식에서 파생된것, GET과 POST로만 나눔)
	...
	//XMLHttpRequest 객체의 준비상태(ReadState)가 변경될 때마다 호출되는 이벤트 처리 함수 - 4번 호출
