...
public class AjaxMemberDAO extends JdbcDAO {
	...
	//아이디(String 객체)를 전달받아 AJAX_MEMBER 테이블의 행을 검색하여 회원정보(AjaxMemberDTO 
	//객체)로 반환하는 메소드
	...
	//이름(String 객체)과 이메일(String 객체)을 전달받아 AJAX_MEMBER 테이블에 저장된 행의 
	//아이디를 검색하여 문자열(String 객체)로 반환하는 메소드
	...
	*/
	...
	//회원정보(AjaxMemberDTO)를 전달받아 AJAX_MEMBER 테이블에 저장된 행의 아이디를 
